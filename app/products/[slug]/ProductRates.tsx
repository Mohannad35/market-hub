...
import { getRatingStats } from "@/lib/query-functions/rate";
...
const ProductRates = ({ slug }: { slug: string }) => {
  ...
  return (
    <Flex direction="column" gapY="4" pb="9">
      <Divider />
      <Flex direction={{ initial: "column", md: "row" }} gapX="4">
        <Flex direction="column" width="25rem" minWidth="25rem" gapY="2">
            ...
            {[5, 4, 3, 2, 1].map((value, i) => {
              ...
              return (
                <Rating.Advanced
                  ...
                  theme={{
                    progress: { base: "mx-4 h-5 w-4/6 rounded bg-gray-200 dark:bg-gray-700" },
                  }}
                >
                  {value} star
                </Rating.Advanced>
